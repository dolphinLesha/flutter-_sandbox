...
abstract class $NavigationStateCopyWith<$Res> {
  ...
  $Res call({@JsonKey() RoutePath currentRoute});
}
...
class _$_NavigationState implements _NavigationState {
  const _$_NavigationState({@JsonKey() this.currentRoute = const RouteBase()});
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(currentRoute));
...
abstract class _NavigationState implements NavigationState {
  const factory _NavigationState({@JsonKey() final RoutePath currentRoute}) =
      _$_NavigationState;
